...
int main(int argc UNUSED, char *argv[])
{
	...
	simple = pathstr_simplify(tmpctx, NULL);
	assert(!simple);

	simple = pathstr_simplify(tmpctx, "");
	assert(!simple);
	...
	simple = pathstr_simplify(tmpctx, "/a/b///");
	assert(streq(simple, "/a/b"));
